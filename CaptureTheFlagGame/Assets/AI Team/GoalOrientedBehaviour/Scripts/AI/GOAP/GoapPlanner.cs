...
namespace Assets.AI_Team.GoalOrientedBehaviour.Scripts.AI.GOAP
{
    /// <summary>
    ...
    public class GoapPlanner
    {
        ...
        public Queue<IGoapAction> Plan(GameObject agent, HashSet<IGoapAction> availableActions, HashSet<KeyValuePair<string, object>> worldState, HashSet<KeyValuePair<string, object>> goals)
        {
            ...
            var usableActions = new HashSet<IGoapAction>();
            foreach (var action in availableActions)
            {
        ...
        private bool BuildGraph(Node parent, Heap<Node> leaves, HashSet<IGoapAction> usableActions, HashSet<KeyValuePair<string, object>> goal)
        {
            var foundOne = false;
        ...
        /// <returns></returns>
        private HashSet<IGoapAction> ActionSubset(IEnumerable<IGoapAction> actions, IGoapAction removeMe)
        {
            var subset = new HashSet<IGoapAction>(actions);
