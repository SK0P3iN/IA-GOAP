...
using System.Linq;
using Assets.AI_Team.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Actions;
using Assets.AI_Team.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Conditions;
...
namespace Assets.AI_Team.GoalOrientedBehaviour.Scripts.AI.GOAP
{
    ...
    public sealed class GoapAgent : MonoBehaviour
    {
        ...
        {
            var actions = GetComponents<IGoapAction>();
