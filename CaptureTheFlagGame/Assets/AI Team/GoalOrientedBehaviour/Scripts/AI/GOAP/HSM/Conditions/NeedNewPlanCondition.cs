...
namespace Assets.AI_Team.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Conditions
{
    /// <summary>
    /// <see cref="ICondition"/> used by the <see cref="HierarchicalStateMachine"/>. Returns true of the <see cref="Assets.GrupoCJJ.Scripts.AI.GOAP.GoapAgent"/> of this state machine needs a new plan
    /// </summary>
